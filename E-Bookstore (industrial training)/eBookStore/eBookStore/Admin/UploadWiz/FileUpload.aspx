<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/UploadWiz/UploadWizMaster.master" AutoEventWireup="true" CodeFile="FileUpload.aspx.cs" Inherits="Admin_UploadWiz_FileUpload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="MainColoumn">
        ...
        <div class="wizardinner">
            Upload the ebook file for
        <asp:Label ID="lblTitle" runat="server"></asp:Label>
            <br />
            <asp:FileUpload ID="FileUpload1" runat="server" />
            &nbsp;<asp:Button ID="btnUpld" runat="server" OnClick="btnUpld_Click" Text="Upload" CssClass="btnGeneric" />
            <br />
