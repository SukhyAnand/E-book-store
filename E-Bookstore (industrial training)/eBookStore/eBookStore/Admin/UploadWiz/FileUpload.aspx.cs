...
public partial class Admin_UploadWiz_FileUpload : System.Web.UI.Page
{
    ...
    protected void btnNext_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("ImageUpload.aspx?TitleId=" + TitleId);
    }
    ...
    protected void btnUpld_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string TitleId = Request.QueryString["TitleId"];
                string dirpath = Server.MapPath("../../Storage/Books/");
